...
public class EstadosServlet extends HttpServlet {
    ...
    protected void processRequest( 
        ...
        System.out.println("chegou aq antes do if");
        try {

            dao = new EstadoDAO();

            if ( acao.equals( "inserir" ) ) {
                System.out.println("chegou aq no inserir do if");
                String nome = request.getParameter( "nome" );
                String sigla = request.getParameter( "sigla" );
                System.out.println("chegou aq no inseri peguei os parametros do if");
                Estado e = new Estado();
                e.setNome( nome );
                e.setSigla( sigla );
                System.out.println("chegou aq no inseri fiz a classe do if");
                dao.salvar( e );
                System.out.println("salvei");
                disp = request.getRequestDispatcher(
                        "/formularios/estados/listagem.jsp" );
                System.out.println("mandei redirecionar ");
